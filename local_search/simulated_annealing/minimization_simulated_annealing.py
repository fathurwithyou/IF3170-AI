...
class MinimizationSimulatedAnnealing(SimulatedAnnealing):
    """
    Simulated Annealing for minimization problems.
    Accepts worse moves (higher values) with decreasing probability.
    """

    def acceptance_probability(self, energy_delta, temperature):
        """
        Calculate probability of accepting a worse move for a MINIMIZATION problem.
